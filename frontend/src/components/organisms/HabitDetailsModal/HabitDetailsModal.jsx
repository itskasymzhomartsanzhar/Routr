...
const HabitDetailsModal = ({ isOpen, onClose, onEdit, habit }) => {
  const [isClosing, setIsClosing] = useState(false)
  const [calendarDate, setCalendarDate] = useState(() => new Date())
  const [isUserDropdownOpen, setIsUserDropdownOpen] = useState(false)
  const [selectedUser, setSelectedUser] = useState('Mikhail Plyasov')
  ...
  const users = ['Mikhail Plyasov', 'Соучастник 1', 'Соучастник 2']
          ...
          <section className="habit-details-modal__section">
            ...
            <div className="habit-details-modal__user-select">
              ...
              >
                <div className="habit-details-modal__user-info">
                  ...
                  ></div>
                  <div className="habit-details-modal__user-name">{selectedUser}</div>
                </div>
                <svg
            ...
            <div className="habit-details-modal__stats-grid">
              <div className="habit-details-modal__stat-card">
                ...
                <div>
                  <div className="habit-details-modal__stat-value">15 дней</div>
              ...
              <div className="habit-details-modal__stat-card">
                <div className="habit-details-modal__stat-icon">📝</div>
                <div>
                  <div className="habit-details-modal__stat-value">0 дней</div>
            ...
            <div className="habit-details-modal__stat-card habit-details-modal__stat-card--wide">
              <div className="habit-details-modal__stat-icon">🔄</div>
              <div>
                <div className="habit-details-modal__stat-value">59 раз</div>
                ...
                return (
                  <div
                    ...
                    className={`habit-details-modal__calendar-day ${
                      isToday ? 'habit-details-modal__calendar-day--active' : ''
                    }`}
                  >
                    {day}
                  </div>
      ...
      {isShareOpen && (
        ...
        >
          ...
          >
            ...
            <button className="habit-details-modal__share-primary" type="button">
              Скопировать ссылку
            </button>
            <button className="habit-details-modal__share-secondary" type="button">
